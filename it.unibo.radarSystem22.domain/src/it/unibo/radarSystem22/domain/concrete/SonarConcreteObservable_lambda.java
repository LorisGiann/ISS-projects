...
public class SonarConcreteObservable_lambda extends SonarModelObservable_lambda implements ISonarObservable_lambda{ 
//same code of SonarConcrete. Cannot use delegation and composition since a call to a locally instantiated SonarConcrete.sonarProduce() will not produce a call to the external SonarModelObservable_lambda.updateDistance() (external = this object superclass), 
//but rather a call to SonarModel.updateDistance() (the superclass of the internally instantiated SonarModel), wich will not update the observers. 
		 ...
		 */
		public SonarConcreteObservable_lambda() {//called by SonarModel constructor
