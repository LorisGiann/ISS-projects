...
public class SonarConcreteObservable_traditional extends SonarModelObservable_traditional implements ISonarObservable_traditional{ 
	//same code of SonarConcrete. Cannot use delegation and composition since a call to a locally instantiated SonarConcrete.sonarProduce() will not produce a call to the external SonarModelObservable_traditional.updateDistance() (external = this object superclass), 
	//but rather a call to SonarModel.updateDistance() (the superclass of the internally instantiated SonarModel), wich will not update the observers. 
			 ...
			 */
			public SonarConcreteObservable_traditional() {//called by SonarModel constructor
